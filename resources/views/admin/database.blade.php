        ...
        <div class="col-md-12">
            <div class="container-content">
                ...
                <div style="margin-left: 20px">
                    <a href="/admin/backup-database"><button type="button" class="btn btn-success">Backup Database</button></a>
                </div>
                <table>
                    <thead>
                    <tr>
                        ...
                        <th class="column-third">Ngày</th>
                        <th class="column-fourth">Action</th>
                    </tr>
                    </thead>
                    <tbody id="bodyHistoryTransactions">
                    @foreach ($databases as $database)
                        <tr>
                            <td class="column-first">{{$loop->index + 1}}</td>
                            <td class="column-second">{{$database->file_name}}</td>
                            <td class="column-third">{{$database->created_at}}</td>
                            <td class="column-fourth">
                                <a href="/admin/restore-database/{{$database->id}}"><button type="button" class="btn btn-success" style="height: 37px">Restore</button></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
